    ...
    return (
        <div className="scholarly-container">
            ...
            <nav className={`navbar ${isScrolled ? 'navbar-scrolled' : ''} ${!isVisible ? 'navbar-hidden' : ''}`}>
                <div className="logo" style={{ width: isScrolled ? '180px' : '220px', transition: 'width 0.4s ease' }}>
                    <img src={twiteLogo} alt="Twite Logo" />
                </div>
                ...
                <div className="hero-container">
                    ...
                    <div className="hero-stats-capsule">
                        ...
                        <div className="stats-right-action">
                            <a href="#video" className="stats-demo-btn" onClick={toggleVideo}>
            ...
            <section className="cta-section">
                <div className="cta-overlay">
                    ...
                    <a href="https://twite.ai/products/" target="_blank" rel="noopener noreferrer" className="cta-btn secondary-cta">Explore More Twite Products</a>
                </div>
            </section>
                ...
                <div className="footer-content">
                    ...
                    <div className="footer-right">
                        <div className="social-links">
                            <a href="https://x.com/Twite_AI" target="_blank" rel="noopener noreferrer" className="social-item">
                                <span className="social-icon">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor"><path d="M24 4.557c-.883.392-1.832.656-2.828.775 1.017-.609 1.798-1.574 2.165-2.724-.951.564-2.005.974-3.127 1.195-.897-.957-2.178-1.555-3.594-1.555-3.179 0-5.515 2.966-4.797 6.045-4.091-.205-7.719-2.165-10.148-5.144-1.29 2.213-.669 5.108 1.523 6.574-.806-.026-1.566-.247-2.229-.616-.054 2.281 1.581 4.415 3.949 4.89-.693.188-1.452.232-2.224.084.626 1.956 2.444 3.379 4.6 3.419-2.07 1.623-4.678 2.348-7.29 2.04 2.179 1.397 4.768 2.212 7.548 2.212 9.142 0 14.307-7.721 13.995-14.646.962-.695 1.797-1.562 2.457-2.549z" /></svg>
                                </span>
                                Twitter
                            </a>
                            <a href="https://www.instagram.com/twite_ai_technologies/" target="_blank" rel="noopener noreferrer" className="social-item">
                                <span className="social-icon">
                            ...
                            <a href="https://www.linkedin.com/company/twite-ai-technologies/posts/?feedView=all" target="_blank" rel="noopener noreferrer" className="social-item">
                                <span className="social-icon">
